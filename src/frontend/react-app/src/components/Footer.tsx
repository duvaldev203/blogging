...
const Footer: React.FC = () => {
  return (
    <footer>
      <div className="py-12 md:py-10 border">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Bottom area */}
          <div className="md:flex md:items-center md:justify-center border-t pt-3">
            ...
            {/* Copyrights note */}
            <div className="text-gray-400 text-sm mr-4">&copy; Blogging 2023. All rights reserved.</div>
