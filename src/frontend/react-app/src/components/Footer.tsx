    ...
    <footer>
      <div className="py-10 md:py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          {/* Bottom area */}
          <div className="md:flex md:items-center md:justify-center border-t pt-3 border-t-slate-400">
            ...
            {/* Copyrights note */}
            <div className="text-gray-700 dark:text-gray-400 text-sm mr-4">&copy; Blogging 2023. All rights reserved.</div>
