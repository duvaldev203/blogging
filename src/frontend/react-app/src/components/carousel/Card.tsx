    ...
    <div className="max-w-sm rounded overflow-hidden shadow-lg bg-gray-800 ">
      ...
      <div className="px-6 py-4">
        <div className="flex space-x-4">
          <div className="font-bold text-xl mb-2 text-gray-300">The Coldest Sunset</div>
        ...
        <p className="text-gray-400 dark:text-gray-300 text-base text-justify">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatibus quia, nulla! Maiores et perferendis eaque, exercitationem praesentium nihil.
        </p>
      </div>
      <div className="mx-6 py-2 border-t border-gray-700">
