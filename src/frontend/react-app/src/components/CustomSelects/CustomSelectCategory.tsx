...
const CustomSelectCategory: React.FC<CustomSelectInputProps> = ({
    inputLabel,
    inputPlaceholder,
    required,
    wrapperStyle,
    ...
    const handleOptionSelect = (selectedValue: CategoryResponse) => {
                ...
                <ul>
                    {isDropdownOpen && inputValue !== '' && (
                        ...
                        >
                            ...
                            >
                                {matchList.length > 0 ? matchList.map((option: CategoryResponse, index) => (
                                    <li
                                        className="dark:border-form-strokedark bg-gray-600 z-50 text-white px-4 py-1 hover:bg-red-600 cursor-pointer w-full custom-select-li"
                                        key={index}
                                    ...
                                    <li
                                        className="dark:border-form-strokedark bg-gray-600 dark:bg-form-input px-4 hover:bg-red-600 justify-center text-center py-2 w-full"
                                    >
                                        {'--- Aucune category n\'a ete trouve ---'}
                                    </li>
                                }
                            </ul>
                        </div>
