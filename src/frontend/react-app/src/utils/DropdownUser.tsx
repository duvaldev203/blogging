...
const DropdownUser = () => {
  ...
  const handleLogOut = () => {
    setTimeout(() => {
      ...
      localStorage.setItem(IS_LOGGED_LOCAL_STORAGE_KEY, '' + false);
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        className={`absolute right-0 mt-4 flex w-52 flex-col rounded-sm border border-gray-500 bg-gray-300 shadow-default dark:border-slate-500 dark:bg-gray-700 ${dropdownOpen === true ? 'block' : 'hidden'
          }`}
      >
        <ul className="flex flex-col gap-5 border-b border-slate-200 px-6 py-5 dark:border-slate-500">
          <li>
            <Link
              to="/profile"
              className="flex items-center gap-3.5 text-sm font-medium duration-300 ease-in-out hover:text-gray-600 dark:hover:text-slate-400 lg:text-base"
            >
              <svg
        ...
        <button className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-gray-600 dark:hover:text-slate-400 lg:text-base"
